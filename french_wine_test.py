...
class FrenchWineDataTester:
    ...
    def test_french_wine_region_bordeaux(self):
        ...
        success, response = self.make_request('GET', 'public-wines?region=Bordeaux', expected_status=200)
        if success:
    ...
    def test_french_wine_region_burgund(self):
        ...
        success, response = self.make_request('GET', 'public-wines?region=Burgund', expected_status=200)
        if success:
            wines = response if isinstance(response, list) else []
    ...
    def test_french_wine_region_champagne(self):
        ...
        success, response = self.make_request('GET', 'public-wines?region=Champagne', expected_status=200)
        if success:
            wines = response if isinstance(response, list) else []
