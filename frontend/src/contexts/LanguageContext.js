...
const translations = {
  de: {
    ...
    // Manifest
    manifesto_title: 'Unsere Leidenschaft – Wein als Kultur & bewusster Genuss',
    ...
    manifesto_point3: 'Wir stehen für bewussten, achtsamen Genuss: Qualität vor Quantität und Genuss statt schlechtem Gewissen.',
  ...
  en: {
    ...
    philosophy_title: 'Wine as Culture & Conscious Enjoyment',
    philosophy_text1: 'Wine is more than a drink – it is an experience, a piece of joy and a deeply rooted part of our civilisation. It tells stories of terroir and craftsmanship and is the ideal companion for life\'s best moments – in relationships, with family, among friends or in business settings.',
    philosophy_text2: 'At WINE.PAIRING.ONLINE we see wine primarily as the ideal partner at the table. It has the power to complete a dish, amplify flavours and turn each bite into a moment of conscious pleasure. In a time where products like wine, beer and spirits are increasingly stigmatised, we choose a positive, mindful stance: when enjoyed with care and in moderation, wine enriches life and is a living expression of culture.',
    philosophy_quote: '"Step into a world where every sip is conscious enjoyment and quality always comes before quantity."',
    ...
    // Manifest
    manifesto_title: 'Our Passion – Wine as Culture & Conscious Enjoyment',
    ...
    manifesto_point3: 'We stand for mindful, conscious enjoyment: quality over quantity and pleasure without guilt.',
    ...
    // Regional Pairings / Sommelier-Kompass
    regional_nav: 'Sommelier Compass',
    regional_tagline: 'Your Global Wine Companion',
    regional_title: 'The Globetrotter Wine Companion',
    regional_subtitle: 'Authentic Culinary Moments & Wine Discoveries for Travelers',
    regional_intro: 'Welcome to the Sommelier Compass – your essential companion on every culinary journey! This section is designed for travelers who don\'t just eat, but want to truly taste the terroir of a country. Each dish is a piece of history, a local soul waiting to be discovered.',
    regional_filter_country: 'Select Country',
    regional_filter_region: 'Select Region',
    regional_filter_search: 'Search dish...',
    regional_filter_all_countries: 'All Countries',
    regional_filter_all_regions: 'All Regions',
    regional_clear_filters: 'Clear filters',
    regional_dish: 'Dish',
    regional_wine_pairing: 'Wine Pairing',
    regional_wine_type: 'Wine Type',
    regional_results: 'Results',
    regional_no_results: 'No results found',
    regional_no_results_desc: 'Try different filters or search terms',
    // Blog
  ...
  fr: {
    ...
    philosophy_title: 'Le vin comme culture & plaisir conscient',
    philosophy_text1: 'Le vin est plus qu\'une boisson – c\'est une expérience, une part de joie de vivre et un élément profondément enraciné de notre civilisation. Il raconte des histoires de terroir et de savoir-faire et accompagne les plus beaux moments – en couple, en famille, entre ami·e·s ou dans un cadre professionnel.',
    philosophy_text2: 'Chez WINE.PAIRING.ONLINE, nous considérons avant tout le vin comme le compagnon idéal du repas. Il a le pouvoir d\'achever un plat, de renforcer les arômes et de transformer chaque bouchée en moment de plaisir conscient. À une époque où des produits comme le vin, la bière et les spiritueux sont de plus en plus stigmatisés, nous défendons un message positif et réfléchi : consommé avec modération et attention, le vin enrichit la vie et est une véritable expression de la culture.',
    philosophy_quote: '«Entrez dans un univers où chaque gorgée est un plaisir conscient et où la qualité prime toujours sur la quantité.»',
    ...
    // Manifeste
    manifesto_title: 'Notre passion – Le vin comme culture & plaisir conscient',
    ...
    manifesto_point3: 'Nous défendons un plaisir réfléchi et conscient : la qualité avant la quantité et le plaisir sans culpabilité.',
    ...
    // Regional Pairings / Sommelier-Kompass
    regional_nav: 'Boussole Sommelier',
    regional_tagline: 'Votre Compagnon Vinicole Mondial',
    regional_title: 'Le Compagnon Vinicole du Globe-Trotter',
    regional_subtitle: 'Moments Culinaires Authentiques & Découvertes Vinicoles pour Voyageurs',
    regional_intro: 'Bienvenue dans la Boussole Sommelier – votre compagnon essentiel pour chaque voyage culinaire ! Cette section est conçue pour les voyageurs qui ne se contentent pas de manger, mais veulent vraiment goûter le terroir d\'un pays. Chaque plat est un morceau d\'histoire, une âme locale qui attend d\'être découverte.',
    regional_filter_country: 'Sélectionner le Pays',
    regional_filter_region: 'Sélectionner la Région',
    regional_filter_search: 'Rechercher un plat...',
    regional_filter_all_countries: 'Tous les Pays',
    regional_filter_all_regions: 'Toutes les Régions',
    regional_clear_filters: 'Effacer les filtres',
    regional_dish: 'Plat',
    regional_wine_pairing: 'Accord Mets-Vin',
    regional_wine_type: 'Type de Vin',
    regional_results: 'Résultats',
    regional_no_results: 'Aucun résultat trouvé',
    regional_no_results_desc: 'Essayez d\'autres filtres ou termes de recherche',
